...
Y aquí viene la parte incómoda. Este mismo post afirmaba `enforce_admins: false`, con su justificación de las tres de la mañana y su apunte sobre el audit log, porque lo copié del spec de diseño del repo. Al comprobarlo contra la API antes de publicar, la configuración real decía `true`: el spec llevaba meses documentando una decisión que la configuración había dejado de reflejar. Es exactamente la tesis de este post cazándome a mí mientras lo escribía.
