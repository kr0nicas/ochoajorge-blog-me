...
coverImage: "https://6pxof7rpjdk6gkca.public.blob.vercel-storage.com/posts/dotfiles-ci-hooks-changelog-catalogo/cover.png"
coverImageAlt: "Una prensa de banco sosteniendo un complejo mecanismo de metal y madera, simbolizando la firmeza de las reglas automatizadas que se hacen cumplir."
---
...
![Un conjunto de candados en una mesa de trabajo, simbolizando los diferentes niveles de protección y sus puntos débiles cuando no hay la herramienta adecuada.](https://6pxof7rpjdk6gkca.public.blob.vercel-storage.com/posts/dotfiles-ci-hooks-changelog-catalogo/inline-1.png)
...
<ComparisonTable
  ...
  rows='[["commit-msg", "Formato, tipo, ámbito, longitud", "No"], ["pre-commit", "Lint de lo staged", "Sí"], ["pre-commit", "Secretos (claves, tokens, .env)", "No"], ["pre-push", "Guardia de main + 2 suites (115 tests)", "Parcial"]]'
  highlight="-1"
/>
...
![Un técnico usando un calibrador para comparar dos planos casi idénticos, con una sutil diferencia revelada, representando la importancia de reusar código en el CI y las trampas de la divergencia.](https://6pxof7rpjdk6gkca.public.blob.vercel-storage.com/posts/dotfiles-ci-hooks-changelog-catalogo/inline-2.png)
...
![Un contador mecánico industrial mostrando un número fijo, contrastando con una nota escrita a mano que muestra un número incorrecto, simbolizando datos leídos del estado real en lugar de hardcodeados.](https://6pxof7rpjdk6gkca.public.blob.vercel-storage.com/posts/dotfiles-ci-hooks-changelog-catalogo/inline-3.png)
